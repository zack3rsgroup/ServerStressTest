...
namespace ServerStressTest
{
    internal class Client
    {
        ...
        private static readonly Dictionary<string, OSType> OperationgSystems = new Dictionary<string, OSType>
        {
            ...
            {"Windows 11", OSType.Windows11},
            {"Windows Server", OSType.WindowsServer},
        ...
        private static readonly string[] RandomNames =
        {
            ...
            "z3ra Hacked", "zgrp ddos", "zack3r top", "Korsar PIDOR", "Artur Donskoy", "Nikita Tupikov", "Maksim", "Liza Spirina",
            "Aleksandr Rogatnev", "Rogatnev PIDOR", "Reddi", "blate", "6late", 
        };
